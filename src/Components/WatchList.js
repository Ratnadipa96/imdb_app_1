...
<div className="text-center">
  ...
  />
    ...
    <table class= 'w-full border-collapse bgwhite text-left text-sm text-gray-500'>
      <thead class= "bg-gray-50">
        ...
        <div className="flex">
                  <img
                    src='https://i.pinimg.com/564x/65/d9/fe/65d9fe108a96608f1f1f5f5d298f8e80.jpg'
                    alt = "upArrow"
                    className="mr-1"
                    onClick={() => {
                      setRating(1);
                  ...
                  <div>Ratings</div>
                  <img
                    src='https://a0.anyrgb.com/pngimg/1698/488/dropdown-list-down-arrow-icon-file-formats-web-design-arrow-button-internet-circle-logo.png'
                    alt = "downArrow"
                    className="ml-1"
                    onClick={() => {
                      setRating(-1);
